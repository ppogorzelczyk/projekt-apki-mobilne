...
const SharedListItem = ({ listItem, listId }: SingleListProps) => {
    ...
    return (
        <TouchableOpacity
            onPress={() => {
                router.navigate({ pathname: "/sharedListItem/[id]", params: { id: listItem.id.toString(), listItem: JSON.stringify(listItem), listId: listId } });
            }}
